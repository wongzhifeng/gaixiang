      ...
      <main className="max-w-4xl mx-auto px-4 py-6">
        {filteredConversations.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-gray-600 mb-2">暂无对话</h3>
            <p className="text-gray-500">在互助广场联系邻居开始对话吧</p>
          </div>
        ) : (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-shrink-0">
                      <div className="w-14 h-14 bg-primary-100 rounded-full flex items-center justify-center relative">
